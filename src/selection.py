...
def selecao_aleatoria_aptidao(populacao, funcao, reducao_por_geracao, verbose=False):
    selecionados = []
...
def selecao_intervalo_aptidao(populacao, funcao, reducao_por_geracao, verbose=False):
    selecionados = []
    qtd_geracao = int((1 - reducao_por_geracao) * len(populacao))
...
def selecao_aptidao(populacao, funcao, reducao_por_geracao, verbose=False):
    qtd_geracao = int((1 - reducao_por_geracao) * len(populacao))
...
def selecao_roleta(populacao, funcao, reducao_por_geracao, verbose=False):
    selecionados = []
    qtd_geracao = int((1 - reducao_por_geracao) * len(populacao))
...
def selecao_ranking(populacao, funcao, reducao_por_geracao, verbose=False):
    selecionados = []
    qtd_geracao = int((1 - reducao_por_geracao) * len(populacao))
